 ...
 *
 */
@ManagedResource(objectName = "eventcount:type=CallMonitor")
@Aspect
public class CallMonitoringAspect {
    ...
    @Around("@annotation(com.eventcount.monitoring.Monitored)")
    public Object invoke(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (this.enabled) {
            ...
            try {
                ...
                publisher.publishEvent(new com.eventcount.monitoring.MonitoringInvokedEvent(
                        method.getName(),
